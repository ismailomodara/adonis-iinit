...
|****************************************************************
*/
// Bouncer.define('getEmployees', (employee: Employee) => {
//   return Roles.MANAGER === employee.roleId
// })

// Bouncer.define('createEmployee', (employee: Employee) => {
//   if(Roles.MANAGER !== employee.roleId) {
//     return Bouncer.deny("You are not authorised to view the request information.", 404)
//   }
//
//   return true
// })
